...
/**
 * Servlet implementation class AggiungiEpisodioServlet
 */
@WebServlet("/AggiungiEpisodioServlet")
public class AggiungiEpisodioServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AggiungiEpisodioServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean ok = episodio.aggiungiEpisodio();
		
		if (ok) {
			risposta= "Episodio Aggiunto";
		}else risposta= "Episodio non aggiunto";

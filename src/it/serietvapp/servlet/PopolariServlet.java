...
/**
 * Servlet implementation class PopolariServlet
 */
@WebServlet("/PopolariServlet")
public class PopolariServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        HttpRequest request1 = HttpRequest.newBuilder()
                .GET()
                .uri(URI.create("https://api.themoviedb.org/3/tv/popular?api_key=567260adb714b7a87e42806ce2ff893e&language=it-IT"))
